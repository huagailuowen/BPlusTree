...
public:
    ...
    int main()
    {
        ...
        BPlusTree<pair<Mystring, int>, int, 200, 200>A("datafile","treefile",false);
        int T;cin>>T;
        while(T--){
            ...
            if(s=="insert"){
                cin>>a>>b;
                A.insert(make_pair(Mystring(a),b), b);
            }
            if(s=="delete"){
                cin>>a>>b;
                A.remove(make_pair(Mystring(a), b));
            }
            if(s=="find"){
                cin>>a;//cout<<"|||";
                vector<int>v;
                A.searchall(make_pair(Mystring(a), 0), make_pair(Mystring(a), 1000000),v);
